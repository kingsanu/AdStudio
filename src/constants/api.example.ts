// Example API constants file - copy to api.ts and update with your values
export const API_URLS = {
  BASE_URL: "https://your-api-service.com/Admin",
  ADS_BASE_URL: "https://your-api-service.com/adstudio",
