...
export default class DDItemComponent extends React.Component<DDItemProps, DDItemState> {
  
  readonly state: DDItemState = { isDragging: false };
  ...
  componentDidUpdate(prevProps: DDItemProps, prevState: DDItemState) {
  ...
  render() {
    // console.log('DDItemComponent.render');
