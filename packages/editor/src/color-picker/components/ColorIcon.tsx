import { forwardRef, ForwardRefRenderFunction, HTMLProps, PropsWithChildren } from 'react';
            ...
            >
                ...
                <div
                    css={{
                        ...
                        borderRadius: 4,
                        boxShadow:
                            selected && new ColorParser(selected).toRgbString() === new ColorParser(color).toRgbString()
